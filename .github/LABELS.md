...
| Label | Color | Description |
|-------|-------|-------------|
| `component:cli` | ![#455a64](https://placehold.co/15x15/455a64/455a64.png) | CLI entry point |
| `component:pipeline` | ![#5c6bc0](https://placehold.co/15x15/5c6bc0/5c6bc0.png) | Pipeline orchestrator |
...
| `component:prompts` | ![#b0bec5](https://placehold.co/15x15/b0bec5/b0bec5.png) | LLM prompt templates |
